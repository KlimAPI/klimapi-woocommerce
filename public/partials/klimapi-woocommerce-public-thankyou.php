...
<div class="klimapi-wrapper-thankyou">
    ...
    <div class="klimapi-thankyou">
        ...
        <p class="klimapi-thankyou-text">
            ...
            <a class="klimapi-thankyou-link" href="<?php echo KLIMAPI_WOOCOMMERCE_CERTIFICATES_ENDPOINT ?>/<?php echo strtolower(substr(get_bloginfo('language'), 0, 2)) ?>/<?php echo $order->order_id ?>" target="_blank"><?php echo __('Open Certificate', 'klimapi'); ?> ➜</a>
        </p>
