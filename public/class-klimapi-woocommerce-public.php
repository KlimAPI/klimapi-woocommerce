 ...
 * @subpackage Klimapi_Woocommerce/public
 */
 ...
 */
class Klimapi_Woocommerce_Public
{
    ...
    public function enqueue_styles()
    {
        ...
        //KlimAPI styles
        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/klimapi-woocommerce-public.css', array(), $this->version, 'all');
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/klimapi-woocommerce-public.js', array( 'jquery' ), $this->version, false);
    ...
    public function klimapi_widget()
    {
        ...
        include plugin_dir_path(__FILE__) . 'partials/klimapi-woocommerce-public-display.php';
    ...
    public function klimapi_thankyou($order_id)
    {
        ...
        include plugin_dir_path(__FILE__) . 'partials/klimapi-woocommerce-public-thankyou.php';
    ...
    public function calculate_cart()
    {
        ...
        //call the api
        $response = wp_remote_post(KLIMAPI_WOOCOMMERCE_API_ENDPOINT . '/v1/shops/' . $shop_key . '/cart', [
            'headers' => [
    ...
    public function process_offset($order_id)
    {
        ...
        //call the api
        $response = wp_remote_post(KLIMAPI_WOOCOMMERCE_API_ENDPOINT . '/v1/shops/' . $shop_key . '/cart/' . wc()->session->get('klimapi_compensation_selected') . '/process', [
            'headers' => [
                'content-type' => 'application/json',
                'X-API-KEY' => $api_key,
                'X-LOCALE' => strtoupper(substr(get_bloginfo('language'), 0, 2)),
