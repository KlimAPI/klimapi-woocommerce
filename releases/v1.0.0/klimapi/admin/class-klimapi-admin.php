...
class Klimapi_Admin
{
    ...
    public function enqueue_styles()
    {
         ...
         * defined in Klimapi_Loader as all of the hooks are defined
         * in that particular class.
         *
         * The Klimapi_Loader will then create the relationship
         * between the defined hooks and the functions defined in this
         * class.
         */

        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/klimapi-admin.css', array(), $this->version, 'all');
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/klimapi-admin.js', array( 'jquery' ), $this->version, false);
    }
    ...
    public function klimapi_settings_menu()
    {
        ...
        add_menu_page(
            ...
            "KlimAPI",
            'manage_options',
            plugin_dir_path(__FILE__) . 'partials/klimapi-admin-display.php',
            null,
            $klimapi_icon,
            99
        );
    ...
    {
        wp_remote_post(KLIMAPI_API_ENDPOINT . '/v1/shops/' . $shop_key . '/sync/bulk', [
            'blocking' => false,
            'headers'  => [
